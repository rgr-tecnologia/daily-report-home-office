...
export function NewForm(props: NewFormProps): JSX.Element {
  const { onSubmit, onUpdate, currentItem } = props;
    ...
    <>
      ...
      <Stack tokens={{ childrenGap: "m" }}>
        <TextField
          ...
          onChange={(event) =>
            onDataChange("Title", (event.target as HTMLInputElement).value)
          }
          label="Title"
          required
        />
        ...
        >
          <Checkbox
            checked={jobItemData.HomeOffice}
            label="Home Office"
            onChange={onChangeHomeOffice}
          />
          <Checkbox
            checked={jobItemData.HoraExtra}
            label="Overtime"
            onChange={onChangeHoraExtra}
          />
